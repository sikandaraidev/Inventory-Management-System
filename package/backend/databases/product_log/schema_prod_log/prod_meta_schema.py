...
class ProductMetadataSchema(BaseModel):
    ...
    def from_sql_product(cls, product_obj):
        ...
        return cls(
            ...
            care_instructions=getattr(product_obj, "care_instructions", None),
            seo_title=getattr(product_obj, "seo_title", None),
            seo_description=getattr(product_obj, "seo_description", None),
            vendor_notes=getattr(product_obj, "vendor_notes", None),
        )
